        ...
        >
          <div class="col-lg-8 ">
            <div class="text w-100 text-center mb-md-5 pb-md-5">
              ...
              >A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts</p>
              <a
            ...
            <div class="row no-gutters">
              <div class="col-md-4 d-flex align-items-center">
                <form action="#" class="request-form  bg-primary">
                  ...
                  <div class="form-group">
                    <label for class="label">Jenis Barang</label>
                    <input
                      type="text"
                      class="form-control"
                      placeholder="Jenis barang yang diservis"
                    />
                  </div>
                  <div class="form-group">
                    <label for class="label">Kerusakan</label>
                    <input
                      type="text"
                      class="form-control"
                      placeholder="Kerusakan yang dialami"
                    />
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-4 d-flex align-self-stretch ">
                      <div class="services w-100 text-center">
                        ...
                        <div class="text w-100">
                          <h3 class="heading mb-2">Isi Data Tentang Anda dan Barang</h3>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4 d-flex align-self-stretch ">
                      <div class="services w-100 text-center">
                        ...
                        <div class="text w-100">
                          <h3 class="heading mb-2">Negosiasi Harga</h3>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4 d-flex align-self-stretch ">
                      <div class="services w-100 text-center">
                        ...
                        <div class="text w-100">
                          <h3 class="heading mb-2">Serviskan barang</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  <p>
                    <a href="#" class="btn btn-primary py-3 px-4">Daftar Sekarang</a>
                  </p>
                </div>
              </div>
            </div>
